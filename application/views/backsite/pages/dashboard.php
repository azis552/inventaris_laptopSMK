                        ...
                        <div class="page-content-wrapper">
                            <div class="row">
                                    ...
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">Laptop </h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">Laptop Siswa</h6>
                                                    <h3 class="mb-3 mt-0"><?=$data_laptop_siswa?></h3>
                                                    <div class="">
                                                        <span class="badge badge-light text-primary"> 0% </span> <span class="ml-2">Tersedia</span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">Laptop</h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">Laptop Sekolah</h6>
                                                    <h3 class="mb-3 mt-0"><?=$data_laptop_peminjaman?></h3>
                                                    <div class="">
                                                        <span class="badge badge-light text-primary"> 0% </span> <span class="ml-2">Tersedia</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">Data</h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">Guru</h6>
                                                    <h3 class="mb-3 mt-0"><?=$data_guru?></h3>
                                                    <div class="">
                                    ...
                                    <div class="card bg-primary mini-stat position-relative">
                                        <div class="card-body">
                                            <div class="mini-stat-desc">
                                                <h6 class="text-uppercase verti-label text-white-50">Data</h6>
                                                <div class="text-white">
                                                    <h6 class="text-uppercase mt-0 text-white-50">Siswa</h6>
                                                    <h3 class="mb-3 mt-0"><?=$data_siswa?></h3>
                                                    <div class="">
                            ...
                            <div class="row">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xl-12 border-right">
                                                    <h4 class="mt-0 header-title mb-4">Grafik Penggunaan Laptop</h4>
                                ...
                                <div class="col-xl-3">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title mb-4">Analisa Penggunaan </h4>
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title mb-3">5 Peminjam Terakhir</h4>
                                            <div class="inbox-wid">
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title mb-5">Pengembalian Terbaru</h4>
                                            <div>
                                ...
                                <div class="col-xl-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title mb-4">Merk Laptop</h4>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title mb-4">Ram Tertinggi</h4>
                                            <div class="table-responsive">
                                                <table class="table table-hover mb-0">
                                                    <thead>
                                                      <tr>
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title mb-4">Processor</h4>
